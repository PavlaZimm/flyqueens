...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://opensky-network.org https://api.adsb.lol https://api.planespotters.net https://aviationweather.gov https://*.liveatc.net",
      "media-src 'self' https://*.liveatc.net",
