    ...
    <main style={{ minHeight: '100dvh', background: 'var(--midnight)', color: 'var(--text-primary)', fontFamily: 'IBM Plex Sans, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 18 }}>
      <div style={{ textAlign: 'center', maxWidth: 440 }}>
        ...
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/radar" style={{ background: 'var(--gold)', color: 'var(--cta-text)', fontFamily: 'Archivo, sans-serif', fontWeight: 800, fontSize: 12, letterSpacing: 1, textTransform: 'uppercase', padding: '10px 16px', borderRadius: 10, textDecoration: 'none' }}>
            Živá mapa
          </Link>
