...
const tzMay = `${cph}/om-cph/presse/nyheder/2026/05/ny%20sikkerhedskontrol%20%C3%A5bner%20i%20k%C3%B8benhavns%20lufthavn`
const sasLounge = `${cph}/en/practical/workspaces-and-lounges/sas-lounge`
  ...
  return (
    <main className={styles.page}>
      ...
      <article className={styles.article}>
        ...
        <div className={styles.tableWrap}>
          <table className={styles.table}>
            ...
            <tbody>
              ...
              <tr><td>Poloha</td><td>ostrov Amager, obec Tårnby (Kastrup), podle AIP 4,4 NM (asi 8 km) jihojihovýchodně od Kodaně</td></tr>
              ...
              <tr><td>Přímé lety z Prahy</td><td>SAS, Norwegian, Ryanair (Ryanair od 3. 11. 2026 do 27. 3. 2027 nelétá)</td></tr>
        ...
        <p>V Praze létají všichni tři dopravci z Terminálu 2 (<a href={prgKodan}>Letiště Praha, destinace Kodaň</a>). V Kodani záleží na směru. Z Prahy přiletíte do Terminálu 3. Zpátky do Prahy odlétá SAS z Terminálu 3, Norwegian a Ryanair z Terminálu 2 (<a href={`${cph}/en/flight-information/arrivals`}>tabule příletů</a> a <a href={`${cph}/en/flight-information/departures`}>odletů</a> letiště Kodaň). Let trvá podle letového řádu 1 hodinu 20 minut se SAS a Norwegianem, s Ryanairem 1 hodinu 25 minut.</p>
        <p>V týdnu od 23. do 29. září 2026 je na lince 40 letů v každém směru: SAS 20, Norwegian 13 a Ryanair 7 (<a href={`${cph}/en/flight-information/departures`}>odletová tabule letiště Kodaň</a>, stav 23. 9. 2026). V zimním letovém řádu jich ubude. SAS dál létá třikrát denně, v sobotu dvakrát. Norwegian má v listopadu, prosinci a únoru čtyři lety týdně a od 4. do 31. ledna jen dva.</p>
        ...
        <p>Terminál 3 se rozšiřuje. Mezi moly B a C přibude nová část o 60 000 m² s dvakrát větší výdejnou zavazadel, větší pasovou kontrolou a víc než třiceti obchody a restauracemi (<a href={tzMarch}>tisková zpráva 13. 3. 2026</a>, <a href={`${cph}/fremtidens-terminal`}>Fremtidens terminal</a>). Otevřít se má v roce 2027. Stavba se týká hlavně odletů z mol C, D, E a F, kvůli ní ale podle letiště nemusíte chodit dřív.</p>
        ...
        <p>Na kontrole pořád platí limit 100 ml na jednu nádobku. Všechny nádobky se musí vejít do jednoho průhledného litrového sáčku na osobu. Sáčky jsou zdarma u stolů před kontrolou (<a href={`${cph}/en/practical/baggage/liquids-in-carry-on-baggage`}>tekutiny v příručním zavazadle</a>). Od 19. května 2026 má letiště novou kontrolu s dvaceti linkami a 3D skenery. Elektroniku na nich necháte v zavazadle a nesundáváte boty, pásek ani hodinky (<a href={tzMay}>tisková zpráva 19. 5. 2026</a>). Skenery by zvládly i větší lahve, chybí ale schválení EU, se kterým letiště počítá do konce roku. Do té doby platí 100 ml.</p>
        <p>Kontrola je vždy otevřená nejméně od 4:00 do 22:00. Když se podle letového řádu létá i v noci, je otevřená nonstop. Na let v rámci Schengenu, tedy i do Prahy, radí letiště přijet nejméně dvě hodiny předem (jedna jeho stránka uvádí dvě a půl), mimo Schengen tři hodiny (<a href={`${cph}/en/practical/check-in`}>časté otázky k odbavení</a>). V roce 2025 se na kontrole čekalo průměrně 4 minuty 14 sekund a 99,4 % cestujících nejvýš čtvrt hodiny (<a href={factsFigures}>Key Facts &amp; Figures 2025</a>).</p>

        <h2 id="odlety-prilety-mapa">Odlety, přílety a mapa letiště online</h2>
        <p>Aktuální stav letů ukazuje letiště na vlastních tabulích <a href={`${cph}/en/flight-information/departures`}>odletů</a> a <a href={`${cph}/en/flight-information/arrivals`}>příletů</a>: čas, cíl, číslo letu i stav, třeba nástup nebo uzavřený gate. Kam se z Kodaně létá, najdete na <a href={`${cph}/en/flight-information/destinations`}>mapě destinací</a>.</p>
        <p>V budovách se zorientujete podle <a href={`${cph}/en/practical/cph-map`}>interaktivní mapy letiště</a>. Po jednotlivých patrech jsou na ní gaty, bezpečnostní i pasová kontrola, toalety, obchody a salonky. Kde je právě letadlo, které vás z Kodaně poveze, uvidíte v <Link href="/radar">radaru FlyQueens</Link>.</p>
        ...
        <p>Kolik skutečně zaplatíte, záleží na termínu. Při dotazu 23. 9. 2026 stál týden od 14. do 21. října, který zčásti spadá do dánských podzimních prázdnin, 1 499 DKK, a to na nejlevnějších volných parkovištích P17 a P19. Několik parkovišť už bylo vyprodaných. Týden od 4. do 11. listopadu vyšel na 499 DKK na P19 a na 549 DKK na P17. V prázdninových termínech se levná parkoviště vyprodávají, rezervujte proto s předstihem.</p>
        ...
        <p>Do většiny salonků za kontrolou si můžete koupit vstup i při letu do Prahy, pokud je volno. Carlsberg Aviator Lounge stojí 229 DKK, Danske Bank Aviator Business Lounge 289 DKK, obě až na tři hodiny. Aspire Lounge vyjde na 339 DKK (<a href={`${cph}/en/practical/workspaces-and-lounges`}>salonky</a>, ceny v detailu jednotlivých salonků). SAS Lounge u gatů C stojí 349 DKK, vstup si ale koupíte jen s palubenkou SAS nebo jiné aerolinky aliance SkyTeam, s Norwegianem ani Ryanairem ne. Pustí vás nejdřív tři hodiny před odletem (<a href={sasLounge}>SAS Lounge</a>).</p>

        <h2 id="spotting">Kde sledovat letadla</h2>
        <p>Oficiální vyhlídku letiště na svém webu neuvádí. Dánská encyklopedie Trap Danmark to vysvětluje bezpečností: do areálu letiště veřejnost nesmí. Na letadla je podle ní nejlepší výhled z konce silnice Amager Landevej, kde stojí Flyvergrillen (<a href={trap}>Trap Danmark, Københavns Lufthavn</a>).</p>
        ...
        <div className={styles.faq}>
          ...
          <p>Let z Prahy do Kodaně trvá podle letového řádu 1 hodinu 20 minut se SAS a Norwegianem, s Ryanairem 1 hodinu 25 minut. Například let SAS SK768 měl 22. září 2026 podle letového řádu odlet z Prahy v 10:20 a přílet do Kodaně v 11:40. Obě země jsou ve stejném časovém pásmu, takže časy v rezervaci nemusíte přepočítávat.</p>
          ...
          <p>Na nejvzdálenějších parkovištích Budget stojí týden při online rezervaci od 499 DKK. V týdnu od 14. do 21. října 2026, který zčásti spadá do dánských podzimních prázdnin, ale stál při dotazu 23. 9. nejméně 1 499 DKK a část parkovišť byla vyprodaná. U vjezdu bez rezervace stojí týden 1 625 až 2 250 DKK. Ceny platí k 23. 9. 2026.</p>
        ...
        <p>Chystáte se do Kodaně poprvé? Na kastrup.cz najdete, <a href="https://kastrup.cz/kodan">co vidět v Kodani</a>. V den odletu si pak na radaru můžete ověřit, kde je letadlo, které vás poveze.</p>
        ...
        <SourcesBox sources={[
          ...
          { label: 'Letiště Kodaň: SAS Lounge, podmínky vstupu', href: sasLounge },
          { label: 'Copenhagen Airports: tisková zpráva 13. 3. 2026', href: tzMarch },
          { label: 'Copenhagen Airports: nová bezpečnostní kontrola, 19. 5. 2026', href: tzMay },
