    ...
    <main className={styles.page}>
      ...
      <article className={styles.article}>
        <ArticleHeader
          ...
          current={post.title}
          eyebrow={post.tag}
          byline=<AuthorByline dateIso={post.date} dateLabel={post.dateLabel} updatedLabel="13. září 2026" readingTime={post.readingTime} />
        >
        ...
        <h2 id="postup-krok-za-krokem">Postup krok za krokem</h2>
        ...
        <h2 id="proc-muze-byt-letadlo-na-mape-trochu">Proč může být letadlo na mapě trochu jinde?</h2>
        <p>
        ...
        <h2 id="co-o-letadle-skutecne-zjistite">Co o letadle skutečně zjistíte</h2>
        ...
        <h2 id="proc-u-nektereho-letadla-chybi-trasa">Proč u některého letadla chybí trasa nebo typ?</h2>
        <p>
        ...
        <h2 id="uvidim-na-mape-kazde-letadlo">Uvidím na mapě každé letadlo?</h2>
        <p>
        ...
        <h2 id="jak-poznat-jestli-letadlo-stoupa-nebo">Jak poznat, jestli letadlo stoupá nebo přistává</h2>
        <p>
        ...
        <div style={{ background: 'var(--midnight-2)', border: '1px solid var(--border-mid)', borderRadius: 12, padding: '16px 18px', margin: '24px 0 10px' }}>
          ...
          <p style={{ marginBottom: 12 }}>Mapa je zdarma a nevyžaduje registraci. Nejlepší výsledek získáte, když ji otevřete hned, dokud je letadlo ještě poblíž.</p>
        ...
        <h2 id="kdyz-si-chcete-letani-take-vyzkouset">Když si chcete létání také vyzkoušet</h2>
        <p>
