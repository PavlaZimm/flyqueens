    ...
    <main className={styles.page}>
      ...
      <article className={styles.article}>
        ...
        <ArticleContents items={[
          { id: 'kde-letiste-lezi-a-jak-se-dostanete-do', label: "Kde letiště leží a jak se dostanete do Kotoru a Budvy?" },
          { id: 'leta-se-do-tivatu-primo-z-prahy-a-brna', label: "Létá se do Tivatu přímo z Prahy a Brna?" },
          { id: 'kolik-stoji-parkovani-u-letiste-tivat', label: "Kolik stojí parkování u letiště Tivat?" },
          { id: 'proc-se-v-tivatu-v-noci-neleta', label: "Proč se v Tivatu v noci nelétá?" },
          { id: 'kde-sledovat-letadla-v-tivatu', label: "Kde sledovat letadla v Tivatu?" },
          { id: 'caste-otazky', label: "Časté otázky" },
        ]} />

        <h2 id="kde-letiste-lezi-a-jak-se-dostanete-do">Kde letiště leží a jak se dostanete do Kotoru a Budvy?</h2>
        ...
        <h2 id="leta-se-do-tivatu-primo-z-prahy-a-brna">Létá se do Tivatu přímo z Prahy a Brna?</h2>
        ...
        <h2 id="kolik-stoji-parkovani-u-letiste-tivat">Kolik stojí parkování u letiště Tivat?</h2>
        ...
        <h2 id="proc-se-v-tivatu-v-noci-neleta">Proč se v Tivatu v noci nelétá?</h2>
        ...
        <h2 id="kde-sledovat-letadla-v-tivatu">Kde sledovat letadla v Tivatu?</h2>
        ...
        <RelatedReading items={[
          ...
          relatedCard('/blog/praha-santiago-de-compostela'),
        ]} />
        <SourcesBox sources={[
